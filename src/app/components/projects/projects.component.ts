...
@Component({
  ...
  providers: [ProjectService]//cargo el servicio en el array de providers
})
...
//
  constructor(
    //cargar mi servicio en un atributo para inyectar el objeto.
...
//para que funcione hay que cargarlos en el Oninit: método que se ejecuta al cargar el componente.
  ngOnInit(){
    this.getProjects();
  }
